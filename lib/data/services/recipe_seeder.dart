...
/// Utility class to seed default recipes in Firestore.
class RecipeSeeder {
  ...
  static Future<void> seed(FirestoreService firestoreService) async {
    for (final recipe in recipes) {
      await firestoreService.addDocument('recipes', {
        ...recipe,
